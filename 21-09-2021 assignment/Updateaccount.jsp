<%@ page language="java" import="java.util.Date,java.sql.*" contentType="text/html; charset=ISO-8859-1"
...
<sql:update dataSource="${db}" var="count">  
   UPDATE customer SET balanceamount = ? WHERE accountnumber = ?  
   <sql:param value="<%=balanceamounts%>"/>  
  <sql:param value="<%=accno%>"/>   
</sql:update>
 <c:if test="${count>=1}">
            <font size="5" color='green'> Congratulations ! Data updated
            successfully.</font>
              <a href="index.jsp"><b>Go Home<b></b></a>          
        </c:if>
